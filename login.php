...
if (isset($_POST['login'])) { //Jika tombol login di klik
    if ($_POST['username'] == 'userlsp' && $_POST['password'] == 'smkisfibjm' || $_POST['username'] == 'userlsp2' && $_POST['password'] == 'smkn2bjm') { //Jika username dan password benar
